...
router.post('/', async (req, res) => {
    try {
        ...
        let valorTotal = 0;
        const produtosComPrecos = await Promise.all(produtos.map(async (produto) => {
            ...
            const tamanhosArray = produtoInfo.tamanhos;
            ...
            data: {
                ...
                produtos: {
                    create: produtosComPrecos.map(produto => ({
                        ...
                        complementos: {
                            create: produto.complementos?.map((complementoId) => ({
